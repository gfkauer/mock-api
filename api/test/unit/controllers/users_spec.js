...
describe('Controller: Users', () => {
    ...
    describe('getById()', () => {
        it('should call send with one user', async () => {
            ...
            await usersController.getById(fakeRequest, response);
            sinon.assert.calledWith(response.send, defaultUser);
        });
    });

    describe('create() user', () => {
        it('should save a new user successfuly', async () => {
    ...
    describe('update() user', () => {
        it('should respond with 200 when the user has been updates', async () => {
            const request = {
                params: {
                    id: fakeId
                },
    ...
    describe('delete() user', () => {
        ...
        context('when an error occurs', () => {
            it('should return 400', async () => {
                ...
                await usersController.remove(fakeRequest, response);
                sinon.assert.calledWith(response.send, 'Error');
            });
        });
    });
